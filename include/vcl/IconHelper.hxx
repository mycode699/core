...
{
public:
    /** Get the desktop file / external icon prefix used by Linux desktop integration. */
    static OUString GetDesktopIntegrationPrefix();

    /** Get icon name as used for app icons by (externally provided) icon themes. */
    static OUString GetAppIconName(sal_uInt16 nIcon);

    /** Get the Start Center desktop file / icon name. */
    static OUString GetStartCenterAppIconName();
