...
constexpr OUStringLiteral kSurface = u"impress-slide-element";
...
bool actionRoutesToDiff(SlideElementAction /*eAction*/) { return true; }

OUString buildImpressSlideElementRequest(const OUString& rActionToken, sal_Int32 nSlideIndex,
                                         const OUString& rElementId, const OUString& rServiceMode)
{
    ...
    aBody.append(',');
    aBody.append("\"target\":{\"slide_index\":");
    aBody.append(static_cast<sal_Int32>(nSlideIndex));
    aBody.append(',');
    aBody.append("\"element_id\":");
    appendEscapedJsonString(aBody, rElementId);
    aBody.append("},");
