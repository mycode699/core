...
std::vector<SlashCommand> BuildMergedSlashCommands()
{
    std::vector<SlashCommand> aCommands = {
        ...
        // 诊断 / 写回策略 / 引导 / 队列（不改主文档）
        { u"/diagnostics"_ustr, u"诊断导出"_ustr, u"Export redacted AI diagnostic pack"_ustr, false },
        { u"/诊断导出"_ustr, u"诊断导出"_ustr, u"导出脱敏诊断包（无密钥/无正文）"_ustr, false },
        { u"/doctor"_ustr, u"诊断导出"_ustr, u"Alias for diagnostics export"_ustr, false },
        { u"/writeback-policy"_ustr, u"写回策略"_ustr, u"Show document write-back permission ladder"_ustr,
          false },
        { u"/写回策略"_ustr, u"写回策略"_ustr, u"文档写回 Ask / 本次 / 本轮 说明"_ustr, false },
        { u"/跳过引导"_ustr, u"跳过引导"_ustr, u"Skip first-run AI welcome card"_ustr, false },
        { u"/完成引导"_ustr, u"完成引导"_ustr, u"Mark first-run onboarding complete"_ustr, false },
        { u"/欢迎"_ustr, u"欢迎"_ustr, u"Show AI welcome / onboarding card"_ustr, false },
        { u"/上下文用量"_ustr, u"上下文用量"_ustr, u"Estimate context token usage chip"_ustr, false },
        { u"/队列"_ustr, u"消息队列"_ustr, u"Show busy-time composer follow-up queue"_ustr, false },
        { u"/queue"_ustr, u"消息队列"_ustr, u"Show composer follow-up queue"_ustr, false },
        { u"/工作台状态"_ustr, u"工作台状态"_ustr, u"Phase · queue · writeback · resource dashboard"_ustr,
          false },
        { u"/workbench"_ustr, u"工作台状态"_ustr, u"Workbench status dashboard"_ustr, false },
        { u"/资源预算"_ustr, u"资源预算"_ustr, u"AI resource envelope / RSS soft budget"_ustr, false },
        { u"/resource"_ustr, u"资源预算"_ustr, u"Resource envelope summary"_ustr, false },
        { u"/引擎"_ustr, u"引擎列表"_ustr, u"List provider slots (JSON manifests)"_ustr, false },
        { u"/providers"_ustr, u"引擎列表"_ustr, u"Provider Slot registry"_ustr, false },
        { u"/策略护栏"_ustr, u"策略护栏"_ustr, u"Policy evolution allow/deny dials"_ustr, false },
        { u"/外写策略"_ustr, u"外写策略"_ustr, u"External-write denier rules"_ustr, false },
        { u"/账本"_ustr, u"事件账本"_ustr, u"Replay local AI event ledger"_ustr, false },
        { u"/ledger"_ustr, u"事件账本"_ustr, u"Event ledger replay"_ustr, false },
        { u"/卡顿策略"_ustr, u"卡顿检测"_ustr, u"Stall detector policy + sample"_ustr, false },
        { u"/沙箱"_ustr, u"沙箱 canary"_ustr, u"Run AI cage canaries (fail-closed)"_ustr, false },
        { u"/cage"_ustr, u"沙箱 canary"_ustr, u"Sandbox canary report"_ustr, false },
        { u"/交接"_ustr, u"账本交接"_ustr, u"Handoff brief from event ledger"_ustr, false },
        { u"/handoff"_ustr, u"账本交接"_ustr, u"Ledger-based handoff brief"_ustr, false },
