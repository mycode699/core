...
inline const AiStringEntry* entryTable()
{
    static const AiStringEntry s_aTable[kEntryCount] = {
        ...
        // DuMate M4 task lifecycle: 排队中 / 运行中 / 待批 / 完成 / 失败 / 已停止
        { "cowork.status.pending",            "排队中",                    "Pending" },
        { "cowork.status.running",            "运行中",                    "Running" },
        { "cowork.status.awaiting_review",    "待批",                      "Awaiting Review" },
        { "cowork.status.applied",            "完成",                      "Applied" },
        { "cowork.status.failed",             "失败",                      "Failed" },
        { "cowork.status.cancelled",          "已停止",                    "Cancelled" },
        ...
        { "cowork.notify.review_ready_body",  "%1 已准备好打开审核",      "%1 ready for review" },
        { "cowork.task.stub_title",           "新任务（待批）",            "New Task (Pending)" },
