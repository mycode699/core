...
$(call gb_CustomTarget_get_target,sysui/rpm): $(rpm_WORKDIR)/$(1)/$(UNIXFILENAME.$(1))-$(2)-menus-$(PKGVERSION)-$(LIBO_VERSION_PATCH).noarch.rpm

$(rpm_WORKDIR)/$(1)-desktop-integration.tar.gz: $(rpm_WORKDIR)/$(1)/$(UNIXFILENAME.$(1))-$(2)-menus-$(PKGVERSION)-$(LIBO_VERSION_PATCH).noarch.rpm
$(rpm_WORKDIR)/$(1)/$(UNIXFILENAME.$(1))-$(2)-menus-$(PKGVERSION)-$(LIBO_VERSION_PATCH).noarch.rpm : \
	...
	$(call gb_Helper_print_on_error,\
		$(RPM) -bb $$< \
			...
			--define "pkgprefix $(UNIXFILENAME.$(1))" \
...
$(rpm_WORKDIR)/%-desktop-integration.tar.gz:
	fakeroot $(GNUTAR) -C $(rpm_WORKDIR)/$* -cf - $(foreach distro,$(RPMDISTROS),$(UNIXFILENAME.$*)-$(distro)-menus-$(PKGVERSION)-$(LIBO_VERSION_PATCH).noarch.rpm) | gzip > $@
