...
icns_mimetypes := database drawing drawing-template extension formula master-document \
                  ...
                  spreadsheet-template text text-template web web-template

icns_files := main.icns \
...
$(eval $(call gb_CustomTarget_CustomTarget,sysui/icns))

$(eval $(call gb_CustomTarget_register_targets,sysui/icns,\
    $(icns_files) \
))

$(eval $(call gb_Package_Package,sysui_osxicons,$(gb_CustomTarget_workdir)/sysui/icns))
$(call gb_Package_get_target,sysui_osxicons): $(call gb_CustomTarget_get_target,sysui/icns)
